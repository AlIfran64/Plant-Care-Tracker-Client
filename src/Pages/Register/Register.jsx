      ...
      <div className=' flex items-center justify-center'>
        <div className="card bg-base-100 w-full max-w-sm">
          <div className="card-body">
            <h1 className='font-bold text-3xl mb-5 text-center'>Please Register</h1>
            ...
            <form onSubmit={handleRegister}>
              ...
              <button type='submit' className="btn bg-[#1F7158] text-white py-4 w-full">Register</button>
            </form>

            {/* go to login */}
            <p className='mt-4 text-center'>
              Already have an account? Please <Link to={'/login'} className='font-semibold text-[#1F7158]'>Login</Link>.
            </p>
          </div>
        </div>
      </div>
