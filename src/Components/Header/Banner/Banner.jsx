      ...
      <SwiperSlide>
        <div className="relative w-full">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black/90 to-transparent flex flex-col justify-center items-start text-white px-20">
            ...
            <p className="mb-8 text-lg text-start">From cozy indoor corners to vibrant outdoor gardens, Plantify brings green to every scene.</p>
      ...
      <SwiperSlide>
        <div className="relative w-full">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black/90 to-transparent flex flex-col justify-center items-start text-white px-20">
            ...
            <p className="mb-8 text-lg text-start">Easily manage your indoor and outdoor plant collections, add new entries, and <br /> monitor their growth in one dashboard.</p>
      ...
      <SwiperSlide>
        <div className="relative w-full">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black/90 to-transparent flex flex-col justify-center items-start text-white px-20">
            ...
            <p className="mb-8 text-lg text-start">Whether it's a sunlit balcony or a shaded corner, explore plants tailored for your <br /> indoor and outdoor needs.</p>
