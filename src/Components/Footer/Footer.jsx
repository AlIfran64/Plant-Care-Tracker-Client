      ...
      <footer className="footer sm:footer-horizontal bg-[#032928] text-white px-10 py-28 place-items-center">
        ...
        <div className='w-44 lg:w-96'>
          <div className='flex justify-center items-center gap-3'>
            <img className='w-8 h-8 lg:w-10 lg:h-10' src="/assets/images/logo.png" alt="logo" />
            <div>
              <p className='text-lg lg:text-3xl font-bold mb-3'>Plantify</p>
            </div>
          </div>
          <p className='text-sm lg:text-lg text-justify'>An Intelligent Plant Care Assistant to Help You Monitor, Nurture, and Grow Healthier Plants with Ease Using Smart Technology and Timely Reminders.</p>
        </div>
        ...
        <div>
          ...
          <NavLink className={({ isActive }) => isActive ? 'underline text-sm lg:text-lg' : ' text-sm lg:text-lg'} to={'/allPlants'}>All Plants</NavLink>
